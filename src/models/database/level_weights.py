...
class LevelWeights:
    ...
    def __init__(self, guild: Guild, message_weight: float, reaction_weight: float, voip_weight: float, playing_weight: float):
        self.guild = guild
        self.message_weight = message_weight
        self.reaction_weight = reaction_weight
        self.voip_weight = voip_weight
        self.playing_weight = playing_weight
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "playing_weight": self.playing_weight
        }
